...
class PSU(models.Model):
    ...
    efficiency_rating = models.ForeignKey(EfficiencyCertification, on_delete=models.PROTECT)
    noise_rating = models.ForeignKey(NoiseCertification, on_delete=models.PROTECT)
